...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/alura_nodejs$1.0.0/src/app/views/livros/form/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<div><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" value=\"" +
    ...
    "\" placeholder=\"00.00\"></div><div><label for=\"descricao\">Descrição:</label><textarea cols=\"20\" rows=\"10\" id=\"descricao\" name=\"descricao\" placeholder=\"fale sobre o livro\">" +
...
marko_template.meta = {
    id: "/alura_nodejs$1.0.0/src/app/views/livros/form/form.marko",
    tags: [
